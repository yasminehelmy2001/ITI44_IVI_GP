...
"image: url(:/bluetoothControl/media/bluetoothMain.png);"));
        ...
        connectedBluetoothDeviceLabel->setGeometry(QRect(260, 200, 350, 50));
        QFont font8;
...
""));
        ...
        valueLabel->setGeometry(QRect(600, 230, 41, 41));
        QFont font9;
...
"border-radius:80px;"));
        ...
        valueLabel_2 = new QLabel(airconditionerPage);
        valueLabel_2->setObjectName(QString::fromUtf8("valueLabel_2"));
        valueLabel_2->setGeometry(QRect(650, 230, 21, 41));
        valueLabel_2->setFont(font9);
        valueLabel_2->setStyleSheet(QString::fromUtf8("color:white;"));
        valueLabel_2->setLineWidth(1);
...
"border:none;"));
        ...
        updatedDateValue->setDate(QDate(2020, 1, 1));
...
"border-radius:50px;"));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        valueLabel_2->setText(QCoreApplication::translate("MainWindow", "C", nullptr));
